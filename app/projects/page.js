          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-10">
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                {/* Hover Content */}
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 z-10">
