  ...
  return (
    <div className="relative flex-1 w-full flex flex-col justify-between overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 flex-1 flex flex-col justify-center items-center my-auto relative z-10 py-6">
        <div className="flex flex-col items-start gap-6 lg:flex-row lg:items-center lg:gap-10 w-full">
          <h1 className="text-white -tracking-xl text-3xl font-semibold text-balance sm:text-4xl md:text-5xl lg:text-7xl leading-[1.12]">
            We build high-impact software for{" "}
            <RotatingText
              texts={["Startups", "Scale-ups", "Enterprises", "Visionaries"]}
          ...
          <div className="lg:max-w-md flex flex-col justify-center shrink-0">
